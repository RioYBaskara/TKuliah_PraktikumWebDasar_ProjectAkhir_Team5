        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-5">
                ...
                <p class="text-muted-custom">
                    Benteng Vredeburg merupakan salah satu bangunan bersejarah di Yogyakarta yang menyimpan nilai penting dalam perjalanan sejarah Indonesia.
                    Museum ini menjadi ruang edukasi publik melalui koleksi, dokumentasi, dan narasi sejarah perjuangan bangsa.
                </p>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="feature-card">
                            ...
                            <h5>Reservasi Terjadwal</h5>
                            <p>Pengunjung memilih tanggal dan jam kunjungan sesuai ketersediaan kuota.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="feature-card">
                            ...
                            <h5>Kuota Real-Time</h5>
                            <p>Sistem mengecek kuota setiap jam secara langsung menggunakan AJAX.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="feature-card">
                            ...
                            <h5>Alur Lebih Tertib</h5>
                            <p>Pemesanan tercatat rapi sehingga admin mudah memantau reservasi.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="feature-card">
                            ...
                            <p>Pembayaran dapat dikonfirmasi secara manual melalui WhatsApp.</p>
                        </div>
                    </div>
                </div>
            </div>
